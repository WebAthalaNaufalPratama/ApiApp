...
export default function ButtonLink({ active = false, className = '', children, ...props }: InertiaLinkProps & { active: boolean }) {
    return (
        <Link
            {...props}
            className={
	 ...
	 viewBox="0 0 32 32" xml:space="preserve" fill='white' width={24} height={24} className='me-3'>
